...
class CreateNodeDialog(QtWidgets.QDialog):
    def __init__(self, parent=None, existing_names=None):
        ...
        kinds = [
            "node","import","instance","primitive","uv_unwrap","texture","texture_pro","texture_layer","split_volume","transforms","scene","export_fbx","html_preview","python","switch","output","llm",
