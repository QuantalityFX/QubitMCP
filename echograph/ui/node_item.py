    ...
    def _render_image_collection_inline(self, y_cursor: int) -> int:
        ...
        class _InlineCanvas(_QtWidgets.QWidget):
            ...
            def load_images(self, paths, *, append: bool = True):
                ...
                # Ensure largest image fits canvas; single global pre-scale.
                ...
                if pre_scale < 1.0:
                    ...
                    for (w, h), pm in zip(base_sizes, base_pixmaps):
                        ...
                        scaled_pixmaps.append(pm.scaled(nw, nh, _QtCore.Qt.KeepAspectRatio, _QtCore.Qt.SmoothTransformation))
                ...
                def _layout(sizes, width_limit):
                    ...
                    for w, h in sizes:
                        if x + w > width_limit - edge_pad and x > edge_pad:
                            ...
                            y += row_h + gap
                            row_h = 0
                        offs.append(_QtCore.QPoint(x, y))
                        row_h = max(row_h, h)
                        x += w + gap
                ...
                if scale_all < 1.0:
                    ...
                    for (w, h), pm in zip(base_sizes, base_pixmaps):
                        ...
                        resized_pixmaps.append(pm.scaled(nw, nh, _QtCore.Qt.KeepAspectRatio, _QtCore.Qt.SmoothTransformation))
