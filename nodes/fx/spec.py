...
class FxTrailWidget(QtWidgets.QWidget):
    ...
    def _resolve_input(self, port_names=None):
        ...
        def _trace(item, depth=0, visited=None):
            ...
            if kind in {"switch", "fx", "fx_trail", "fx_splat_physics", "fx splat physics", "splat_physics", "splat physics", "splatphysics", "fx_splat_fx", "fx splat fx", "splat_fx", "splat fx", "fx_splat_glow", "fx splat glow", "splat_glow", "splat glow", "splatglow", "colorize", "splat_colorize", "splat colorize", "fx_splat_colorize", "fx splat colorize", "gaussian_colorize", "gaussian colorize", "transforms", "mnaterial", "material", "texture", "texture_pro", "texture_layer", "uv_unwrap", "instance"}:
