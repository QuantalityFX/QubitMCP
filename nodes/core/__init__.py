...
def register_defaults() -> None:
    ...
    register("groom_guides", stripe_color="#7a5842")
    register("groom_guide_pose", stripe_color="#7a5842")
    register("groom_guide_sim", stripe_color="#7a5842")
    register("groom_deform", stripe_color="#7a5842")
